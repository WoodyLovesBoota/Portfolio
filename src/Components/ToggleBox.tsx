              ...
              {title === 0 ? (
                <ContentToggle>
                  ...
                  <ContentRow>
                    ...
                    <ContentDescription>
                      Solidity 언어를 사용하여 이더리움 플랫폼에서 스마트 컨트랙트를 설계하고 구현할
                      수 있습니다. 또한 스마트 컨트랙트 보안 감사 분야에서의 경험을 바탕으로 코드를
                      꼼꼼하게 검토하여 프로젝트의 안정성을 높이는 데 기여할 수 있습니다.
                    </ContentDescription>
                  </ContentRow>
                </ContentToggle>
              ) : title === 1 ? (
                  ...
                  <ContentRow>
                    ...
                    <CareerBox>
                      ...
                      <ContentDescription>
                        ...
                        NFT, Dapp, ERC20 등 다양한 분야의 스마트 컨트랙트를 설계하고 구현하였습니다.
                      </ContentDescription>
                    </CareerBox>
                  </ContentRow>
                </ContentToggle>
                ...
                <ContentToggle>
                  <ContentRow>
                    ...
                    <CareerBox>
                      ...
                      <ContentDescription>
                        서울대학교 전기정보 공학부 재학 중 소프트웨어 공학을 세부전공하여 소프트웨어
                        개발과 관련된 지식을 쌓았습니다. C, C++, Java, Python, Javascript 등 다양한
                        프로그래밍 언어를 학습하였고, 자료구조, 알고리즘, 컴퓨터 구조, 네트워크 등
                        소프트웨어 공학의 기초와 더불어 블록체인, 머신러닝, 데이터 통신 등 현대적인
                        소프트웨어 기술을 학습하였습니다.
                      </ContentDescription>
                    </CareerBox>
                  </ContentRow>
